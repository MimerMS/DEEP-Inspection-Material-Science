...
def main() -> None:
    ...
    optimizer_googlenet = optim.Adam(model_googlenet.googlenet.fc.parameters(), lr=0.001)
    num_epochs = EPOCHS
    ...
    model_path = os.path.join(model_dir, "googlenet_defect_classifier.pth")
    ...
    # Model validation
    test_ret = test(test_loader, model_googlenet, criterion)
